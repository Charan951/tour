  ...
  return (
    <div className="space-y-2">
      ...
      <div className="flex items-center gap-3">
        <label className="px-4 py-2.5 rounded-xl bg-slate-800 border border-slate-700 hover:bg-slate-700 text-xs font-bold text-aqua-500 flex items-center gap-2 cursor-pointer transition-all shadow-md">
          {uploading ? (
            <>
              <Loader2 className="w-4 h-4 animate-spin text-aqua-500" />
        ...
        {previewUrl && (
          <div className="flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/30 px-3 py-1.5 rounded-xl text-[0.6875rem] text-emerald-400 font-medium">
      ...
      {previewUrl && (
        <div className="relative h-28 w-48 rounded-xl overflow-hidden border border-slate-700 mt-2 shadow-md">
          ...
          <span className="absolute bottom-1 right-1 bg-slate-950/80 text-[0.6875rem] text-emerald-400 font-bold px-1.5 py-0.5 rounded">
            Cloudinary Live
          </span>
        </div>
      )}
