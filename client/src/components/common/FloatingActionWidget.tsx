...
export const FloatingActionWidget: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3 font-['Plus_Jakarta_Sans']">
      ...
      {/* BOTTOM BUTTON: Official WhatsApp Support Button */}
      <a
        href={`https://wa.me/${whatsapp}`}
        target="_blank"
        rel="noreferrer"
        className="group relative flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20ba5a] text-white shadow-2xl hover:scale-110 transition-all duration-300 border-2 border-white/80 cursor-pointer"
