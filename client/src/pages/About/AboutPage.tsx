    ...
    <>
      ...
      <div className="pt-28 pb-20 px-4 max-w-7xl mx-auto space-y-16">
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="font-['Outfit'] font-bold text-4xl sm:text-5xl text-slate-900">
            About HolidayCity
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="glass-card rounded-3xl p-8 border border-slate-200/80 space-y-3">
            ...
            <h3 className="font-['Outfit'] font-bold text-2xl text-slate-900">Our Vision</h3>
          ...
          <div className="glass-card rounded-3xl p-8 border border-slate-200/80 space-y-3">
            ...
            <h3 className="font-['Outfit'] font-bold text-2xl text-slate-900">Our Mission</h3>
            <p className="text-slate-600 text-sm leading-relaxed">
